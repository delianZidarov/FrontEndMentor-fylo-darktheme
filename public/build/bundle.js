    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-spr1ts");
    			add_location(h2, file$5, 127, 0, 3339);
    			attr_dev(p0, "class", "svelte-spr1ts");
    			add_location(p0, file$5, 128, 0, 3371);
    			attr_dev(input, "type", "email");
    			attr_dev(input, "placeholder", "email@example.com");
    			input.required = true;
    			attr_dev(input, "class", "svelte-spr1ts");
    			add_location(input, file$5, 130, 0, 3539);
    			attr_dev(p1, "class", "error-display svelte-spr1ts");
    			toggle_class(p1, "error", !correctEmailFormat(/*inputValue*/ ctx[0]));
    			add_location(p1, file$5, 131, 0, 3627);
    			attr_dev(button, "class", "svelte-spr1ts");
    			add_location(button, file$5, 132, 0, 3703);
    			attr_dev(div0, "class", "svelte-spr1ts");
    			add_location(div0, file$5, 129, 0, 3533);
    			attr_dev(form, "class", "svelte-spr1ts");
    			add_location(form, file$5, 126, 4, 3332);
    			attr_dev(div1, "class", "signup-container svelte-spr1ts");
    			add_location(div1, file$5, 125, 0, 3297);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-aqbgvv");
    			add_location(img, file$4, 78, 4, 1913);
    			attr_dev(div0, "class", "hero-image svelte-aqbgvv");
    			add_location(div0, file$4, 77, 0, 1884);
    			attr_dev(h1, "class", "svelte-aqbgvv");
    			add_location(h1, file$4, 81, 0, 2016);
    			attr_dev(p, "class", "svelte-aqbgvv");
    			add_location(p, file$4, 82, 0, 2085);
    			attr_dev(button, "class", "btn svelte-aqbgvv");
    			add_location(button, file$4, 84, 2, 2254);
    			attr_dev(section, "class", "svelte-aqbgvv");
    			add_location(section, file$4, 80, 0, 2006);
    			attr_dev(div1, "class", "main-sales svelte-aqbgvv");
    			add_location(div1, file$4, 76, 0, 1859);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-cb749u");
    			add_location(img, file$2, 111, 8, 2404);
    			attr_dev(div0, "class", "image-container svelte-cb749u");
    			add_location(div0, file$2, 110, 4, 2366);
    			attr_dev(h2, "class", "svelte-cb749u");
    			add_location(h2, file$2, 115, 8, 2552);
    			attr_dev(p0, "class", "svelte-cb749u");
    			add_location(p0, file$2, 116, 8, 2603);
    			attr_dev(p1, "class", "svelte-cb749u");
    			add_location(p1, file$2, 118, 8, 2742);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "svelte-cb749u");
    			add_location(a, file$2, 121, 12, 2932);
    			attr_dev(circle, "id", "b");
    			attr_dev(circle, "cx", "6");
    			attr_dev(circle, "cy", "6");
    			attr_dev(circle, "r", "6");
    			add_location(circle, file$2, 122, 124, 3095);
    			attr_dev(feOffset, "in", "SourceAlpha");
    			attr_dev(feOffset, "result", "shadowOffsetOuter1");
    			add_location(feOffset, file$2, 122, 252, 3223);
    			...
    			add_location(feGaussianBlur, file$2, 122, 308, 3279);
    			...
    			add_location(feColorMatrix, file$2, 122, 392, 3363);
    			...
    			add_location(filter, file$2, 122, 160, 3131);
    			add_location(defs, file$2, 122, 118, 3089);
    			attr_dev(use0, "fill", "#000");
    			attr_dev(use0, "filter", "url(#a)");
    			xlink_attr(use0, "xlink:href", "#b");
    			add_location(use0, file$2, 122, 600, 3571);
    			attr_dev(use1, "id", "change-bg");
    			xlink_attr(use1, "xlink:href", "#b");
    			attr_dev(use1, "class", "svelte-cb749u");
    			add_location(use1, file$2, 122, 651, 3622);
    			attr_dev(g0, "transform", "translate(2 2)");
    			add_location(g0, file$2, 122, 570, 3541);
    			attr_dev(path, "d", "M8.582 6l-.363.35 1.452 1.4H5.333v.5h4.338L8.22 9.65l.363.35 2.074-2z");
    			attr_dev(path, "fill", "#1B2330");
    			add_location(path, file$2, 122, 693, 3664);
    			attr_dev(g1, "fill", "none");
    			attr_dev(g1, "fill-rule", "evenodd");
    			add_location(g1, file$2, 122, 535, 3506);
    			attr_dev(svg, "width", "16");
    			attr_dev(svg, "height", "16");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "xmlns:xlink", "http://www.w3.org/1999/xlink");
    			add_location(svg, file$2, 122, 12, 2983);
    			attr_dev(div1, "class", "link-container svelte-cb749u");
    			add_location(div1, file$2, 120, 8, 2891);
    			attr_dev(div2, "class", "productivity-description svelte-cb749u");
    			add_location(div2, file$2, 114, 4, 2505);
    			attr_dev(section, "class", "productive-container svelte-cb749u");
    			add_location(section, file$2, 109, 0, 2323);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "bg-quotes svelte-1e23t4k");
    			add_location(img0, file$1, 93, 4, 2171);
    			attr_dev(p0, "class", "svelte-1e23t4k");
    			add_location(p0, file$1, 95, 8, 2262);
    			...
    			attr_dev(img1, "class", "profile-pic svelte-1e23t4k");
    			add_location(img1, file$1, 98, 12, 2481);
    			attr_dev(h20, "class", "svelte-1e23t4k");
    			add_location(h20, file$1, 99, 12, 2567);
    			attr_dev(p1, "class", "user-description svelte-1e23t4k");
    			add_location(p1, file$1, 100, 12, 2601);
    			attr_dev(div0, "class", "user-information-container svelte-1e23t4k");
    			add_location(div0, file$1, 97, 8, 2428);
    			attr_dev(div1, "class", "testimonial svelte-1e23t4k");
    			add_location(div1, file$1, 94, 4, 2228);
    			attr_dev(p2, "class", "svelte-1e23t4k");
    			add_location(p2, file$1, 104, 8, 2720);
    			...
    			attr_dev(img2, "class", "profile-pic svelte-1e23t4k");
    			add_location(img2, file$1, 107, 12, 2939);
    			attr_dev(h21, "class", "svelte-1e23t4k");
    			add_location(h21, file$1, 108, 12, 3028);
    			attr_dev(p3, "class", "user-description svelte-1e23t4k");
    			add_location(p3, file$1, 109, 12, 3064);
    			attr_dev(div2, "class", "user-information-container svelte-1e23t4k");
    			add_location(div2, file$1, 106, 8, 2886);
    			attr_dev(div3, "class", "testimonial svelte-1e23t4k");
    			add_location(div3, file$1, 103, 4, 2686);
    			attr_dev(p4, "class", "svelte-1e23t4k");
    			add_location(p4, file$1, 113, 8, 3182);
    			if (!src_url_equal(img3.src, img3_src_value = "./images/profile-3.jpg")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "Iva Boy");
    			attr_dev(img3, "class", "profile-pic svelte-1e23t4k");
    			add_location(img3, file$1, 116, 12, 3401);
    			attr_dev(h22, "class", "svelte-1e23t4k");
    			add_location(h22, file$1, 117, 12, 3483);
    			attr_dev(p5, "class", "user-description svelte-1e23t4k");
    			add_location(p5, file$1, 118, 12, 3512);
    			attr_dev(div4, "class", "user-information-container svelte-1e23t4k");
    			add_location(div4, file$1, 115, 8, 3348);
    			attr_dev(div5, "class", "testimonial svelte-1e23t4k");
    			add_location(div5, file$1, 112, 4, 3148);
    			attr_dev(section, "class", "testimonials-container svelte-1e23t4k");
    			add_location(section, file$1, 92, 0, 2126);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(header, "class", "svelte-lqqh38");
    			add_location(header, file, 41, 0, 905);
    			attr_dev(div, "class", "position-sign-up svelte-lqqh38");
    			add_location(div, file, 49, 1, 1008);
    			attr_dev(main, "class", "svelte-lqqh38");
    			add_location(main, file, 44, 0, 938);
    			attr_dev(footer1, "class", "svelte-lqqh38");
    			add_location(footer1, file, 53, 0, 1066);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
