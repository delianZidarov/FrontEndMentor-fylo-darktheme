    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-18e92h8");
    			add_location(h2, file$5, 112, 0, 2912);
    			attr_dev(p0, "class", "svelte-18e92h8");
    			add_location(p0, file$5, 113, 0, 2944);
    			attr_dev(input, "type", "email");
    			attr_dev(input, "placeholder", "email@example.com");
    			input.required = true;
    			attr_dev(input, "class", "svelte-18e92h8");
    			add_location(input, file$5, 115, 0, 3112);
    			attr_dev(p1, "class", "error-display svelte-18e92h8");
    			toggle_class(p1, "error", !correctEmailFormat(/*inputValue*/ ctx[0]));
    			add_location(p1, file$5, 116, 0, 3200);
    			attr_dev(button, "class", "svelte-18e92h8");
    			add_location(button, file$5, 117, 0, 3276);
    			attr_dev(div0, "class", "svelte-18e92h8");
    			add_location(div0, file$5, 114, 0, 3106);
    			attr_dev(form, "class", "svelte-18e92h8");
    			add_location(form, file$5, 111, 4, 2905);
    			attr_dev(div1, "class", "signup-container svelte-18e92h8");
    			add_location(div1, file$5, 110, 0, 2870);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-19nxpw6");
    			add_location(img, file$2, 94, 8, 2042);
    			attr_dev(div0, "class", "image-container svelte-19nxpw6");
    			add_location(div0, file$2, 93, 4, 2004);
    			attr_dev(h2, "class", "svelte-19nxpw6");
    			add_location(h2, file$2, 98, 8, 2190);
    			attr_dev(p0, "class", "svelte-19nxpw6");
    			add_location(p0, file$2, 99, 8, 2241);
    			attr_dev(p1, "class", "svelte-19nxpw6");
    			add_location(p1, file$2, 101, 8, 2380);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "svelte-19nxpw6");
    			add_location(a, file$2, 104, 12, 2570);
    			attr_dev(circle, "id", "b");
    			attr_dev(circle, "cx", "6");
    			attr_dev(circle, "cy", "6");
    			attr_dev(circle, "r", "6");
    			add_location(circle, file$2, 105, 124, 2733);
    			attr_dev(feOffset, "in", "SourceAlpha");
    			attr_dev(feOffset, "result", "shadowOffsetOuter1");
    			add_location(feOffset, file$2, 105, 252, 2861);
    			...
    			add_location(feGaussianBlur, file$2, 105, 308, 2917);
    			...
    			add_location(feColorMatrix, file$2, 105, 392, 3001);
    			...
    			add_location(filter, file$2, 105, 160, 2769);
    			add_location(defs, file$2, 105, 118, 2727);
    			attr_dev(use0, "fill", "#000");
    			attr_dev(use0, "filter", "url(#a)");
    			xlink_attr(use0, "xlink:href", "#b");
    			add_location(use0, file$2, 105, 600, 3209);
    			attr_dev(use1, "id", "change-bg");
    			xlink_attr(use1, "xlink:href", "#b");
    			attr_dev(use1, "class", "svelte-19nxpw6");
    			add_location(use1, file$2, 105, 651, 3260);
    			attr_dev(g0, "transform", "translate(2 2)");
    			add_location(g0, file$2, 105, 570, 3179);
    			attr_dev(path, "d", "M8.582 6l-.363.35 1.452 1.4H5.333v.5h4.338L8.22 9.65l.363.35 2.074-2z");
    			attr_dev(path, "fill", "#1B2330");
    			add_location(path, file$2, 105, 693, 3302);
    			attr_dev(g1, "fill", "none");
    			attr_dev(g1, "fill-rule", "evenodd");
    			add_location(g1, file$2, 105, 535, 3144);
    			attr_dev(svg, "width", "16");
    			attr_dev(svg, "height", "16");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "xmlns:xlink", "http://www.w3.org/1999/xlink");
    			add_location(svg, file$2, 105, 12, 2621);
    			attr_dev(div1, "class", "link-container svelte-19nxpw6");
    			add_location(div1, file$2, 103, 8, 2529);
    			attr_dev(div2, "class", "productivity-description svelte-19nxpw6");
    			add_location(div2, file$2, 97, 4, 2143);
    			attr_dev(section, "class", "productive-container svelte-19nxpw6");
    			add_location(section, file$2, 92, 0, 1961);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "bg-quotes svelte-ms4k9f");
    			add_location(img0, file$1, 77, 4, 1793);
    			attr_dev(p0, "class", "svelte-ms4k9f");
    			add_location(p0, file$1, 79, 8, 1884);
    			...
    			attr_dev(img1, "class", "profile-pic svelte-ms4k9f");
    			add_location(img1, file$1, 82, 12, 2103);
    			attr_dev(h20, "class", "svelte-ms4k9f");
    			add_location(h20, file$1, 83, 12, 2189);
    			attr_dev(p1, "class", "user-description svelte-ms4k9f");
    			add_location(p1, file$1, 84, 12, 2223);
    			attr_dev(div0, "class", "user-information-container svelte-ms4k9f");
    			add_location(div0, file$1, 81, 8, 2050);
    			attr_dev(div1, "class", "testimonial svelte-ms4k9f");
    			add_location(div1, file$1, 78, 4, 1850);
    			attr_dev(p2, "class", "svelte-ms4k9f");
    			add_location(p2, file$1, 88, 8, 2342);
    			...
    			attr_dev(img2, "class", "profile-pic svelte-ms4k9f");
    			add_location(img2, file$1, 91, 12, 2561);
    			attr_dev(h21, "class", "svelte-ms4k9f");
    			add_location(h21, file$1, 92, 12, 2650);
    			attr_dev(p3, "class", "user-description svelte-ms4k9f");
    			add_location(p3, file$1, 93, 12, 2686);
    			attr_dev(div2, "class", "user-information-container svelte-ms4k9f");
    			add_location(div2, file$1, 90, 8, 2508);
    			attr_dev(div3, "class", "testimonial svelte-ms4k9f");
    			add_location(div3, file$1, 87, 4, 2308);
    			attr_dev(p4, "class", "svelte-ms4k9f");
    			add_location(p4, file$1, 97, 8, 2804);
    			if (!src_url_equal(img3.src, img3_src_value = "./images/profile-3.jpg")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "Iva Boy");
    			attr_dev(img3, "class", "profile-pic svelte-ms4k9f");
    			add_location(img3, file$1, 100, 12, 3023);
    			attr_dev(h22, "class", "svelte-ms4k9f");
    			add_location(h22, file$1, 101, 12, 3105);
    			attr_dev(p5, "class", "user-description svelte-ms4k9f");
    			add_location(p5, file$1, 102, 12, 3134);
    			attr_dev(div4, "class", "user-information-container svelte-ms4k9f");
    			add_location(div4, file$1, 99, 8, 2970);
    			attr_dev(div5, "class", "testimonial svelte-ms4k9f");
    			add_location(div5, file$1, 96, 4, 2770);
    			attr_dev(section, "class", "testimonials-container svelte-ms4k9f");
    			add_location(section, file$1, 76, 0, 1748);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(header, "class", "svelte-8fw1se");
    			add_location(header, file, 33, 0, 778);
    			attr_dev(div, "class", "position-sign-up svelte-8fw1se");
    			add_location(div, file, 41, 1, 881);
    			attr_dev(main, "class", "svelte-8fw1se");
    			add_location(main, file, 36, 0, 811);
    			attr_dev(footer1, "class", "svelte-8fw1se");
    			add_location(footer1, file, 45, 0, 939);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
