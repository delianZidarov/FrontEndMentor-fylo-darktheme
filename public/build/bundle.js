    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-10kq3cj");
    			add_location(img, file$2, 66, 0, 1490);
    			attr_dev(div0, "class", "image-container svelte-10kq3cj");
    			add_location(div0, file$2, 65, 0, 1460);
    			attr_dev(h2, "class", "svelte-10kq3cj");
    			add_location(h2, file$2, 68, 0, 1582);
    			attr_dev(p0, "class", "svelte-10kq3cj");
    			add_location(p0, file$2, 69, 0, 1625);
    			attr_dev(p1, "class", "svelte-10kq3cj");
    			add_location(p1, file$2, 71, 0, 1750);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "svelte-10kq3cj");
    			add_location(a, file$2, 74, 0, 1916);
    			attr_dev(circle, "id", "b");
    			attr_dev(circle, "cx", "6");
    			attr_dev(circle, "cy", "6");
    			attr_dev(circle, "r", "6");
    			add_location(circle, file$2, 76, 116, 2106);
    			attr_dev(feOffset, "in", "SourceAlpha");
    			attr_dev(feOffset, "result", "shadowOffsetOuter1");
    			add_location(feOffset, file$2, 76, 244, 2234);
    			...
    			add_location(feGaussianBlur, file$2, 76, 300, 2290);
    			...
    			add_location(feColorMatrix, file$2, 76, 384, 2374);
    			...
    			add_location(filter, file$2, 76, 152, 2142);
    			add_location(defs, file$2, 76, 110, 2100);
    			attr_dev(use0, "fill", "#000");
    			attr_dev(use0, "filter", "url(#a)");
    			xlink_attr(use0, "xlink:href", "#b");
    			add_location(use0, file$2, 76, 592, 2582);
    			attr_dev(use1, "id", "change-bg");
    			xlink_attr(use1, "xlink:href", "#b");
    			attr_dev(use1, "class", "svelte-10kq3cj");
    			add_location(use1, file$2, 76, 643, 2633);
    			attr_dev(g0, "transform", "translate(2 2)");
    			add_location(g0, file$2, 76, 562, 2552);
    			attr_dev(path, "d", "M8.582 6l-.363.35 1.452 1.4H5.333v.5h4.338L8.22 9.65l.363.35 2.074-2z");
    			attr_dev(path, "fill", "#1B2330");
    			add_location(path, file$2, 76, 685, 2675);
    			attr_dev(g1, "fill", "none");
    			attr_dev(g1, "fill-rule", "evenodd");
    			add_location(g1, file$2, 76, 527, 2517);
    			attr_dev(svg, "width", "16");
    			attr_dev(svg, "height", "16");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "xmlns:xlink", "http://www.w3.org/1999/xlink");
    			add_location(svg, file$2, 76, 4, 1994);
    			attr_dev(div1, "class", "link-container svelte-10kq3cj");
    			add_location(div1, file$2, 73, 2, 1887);
    			attr_dev(section, "class", "productive-container svelte-10kq3cj");
    			add_location(section, file$2, 64, 0, 1421);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
