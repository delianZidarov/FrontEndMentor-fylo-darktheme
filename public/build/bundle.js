    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "svelte-1xkh850");
    			add_location(img0, file$6, 117, 4, 2819);
    			attr_dev(div0, "class", "footer-logo svelte-1xkh850");
    			add_location(div0, file$6, 116, 0, 2789);
    			...
    			attr_dev(img1, "class", "address svelte-1xkh850");
    			add_location(img1, file$6, 120, 8, 2905);
    			attr_dev(p0, "class", "svelte-1xkh850");
    			add_location(p0, file$6, 121, 12, 2988);
    			if (!src_url_equal(img2.src, img2_src_value = "./images/icon-phone.svg")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "Phone");
    			attr_dev(img2, "class", "phone svelte-1xkh850");
    			add_location(img2, file$6, 124, 8, 3132);
    			add_location(p1, file$6, 125, 12, 3206);
    			if (!src_url_equal(img3.src, img3_src_value = "./images/icon-email.svg")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "Email");
    			attr_dev(img3, "class", "email svelte-1xkh850");
    			add_location(img3, file$6, 126, 8, 3237);
    			add_location(p2, file$6, 127, 12, 3311);
    			attr_dev(section0, "class", "container svelte-1xkh850");
    			add_location(section0, file$6, 119, 0, 2869);
    			attr_dev(a0, "class", "svelte-1xkh850");
    			add_location(a0, file$6, 130, 2, 3382);
    			attr_dev(a1, "class", "svelte-1xkh850");
    			add_location(a1, file$6, 131, 2, 3400);
    			attr_dev(a2, "class", "svelte-1xkh850");
    			add_location(a2, file$6, 132, 2, 3414);
    			attr_dev(a3, "class", "svelte-1xkh850");
    			add_location(a3, file$6, 133, 2, 3429);
    			attr_dev(section1, "class", "links-container svelte-1xkh850");
    			add_location(section1, file$6, 129, 0, 3346);
    			attr_dev(a4, "class", "svelte-1xkh850");
    			add_location(a4, file$6, 136, 2, 3488);
    			attr_dev(a5, "class", "svelte-1xkh850");
    			add_location(a5, file$6, 137, 2, 3508);
    			attr_dev(a6, "class", "svelte-1xkh850");
    			add_location(a6, file$6, 138, 2, 3523);
    			attr_dev(section2, "class", "links-container svelte-1xkh850");
    			add_location(section2, file$6, 135, 0, 3452);
    			attr_dev(a7, "href", "");
    			attr_dev(a7, "aria-label", "facebook");
    			attr_dev(a7, "class", "svelte-1xkh850");
    			add_location(a7, file$6, 142, 4, 3624);
    			attr_dev(div1, "class", "social-icon svelte-1xkh850");
    			add_location(div1, file$6, 141, 4, 3594);
    			attr_dev(a8, "href", "");
    			attr_dev(a8, "aria-label", "twitter");
    			attr_dev(a8, "class", "svelte-1xkh850");
    			add_location(a8, file$6, 145, 4, 3750);
    			attr_dev(div2, "class", "social-icon svelte-1xkh850");
    			add_location(div2, file$6, 144, 4, 3720);
    			attr_dev(a9, "href", "");
    			attr_dev(a9, "aria-label", "instagram");
    			attr_dev(a9, "class", "svelte-1xkh850");
    			add_location(a9, file$6, 148, 4, 3873);
    			attr_dev(div3, "class", "social-icon svelte-1xkh850");
    			add_location(div3, file$6, 147, 4, 3843);
    			add_location(section3, file$6, 150, 0, 3966);
    			attr_dev(section4, "class", "social-media-container svelte-1xkh850");
    			add_location(section4, file$6, 140, 0, 3549);
    			attr_dev(div4, "class", "footer svelte-1xkh850");
    			add_location(div4, file$6, 115, 0, 2768);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-1bck");
    			add_location(h2, file$5, 126, 0, 3280);
    			attr_dev(p0, "class", "svelte-1bck");
    			add_location(p0, file$5, 127, 0, 3312);
    			attr_dev(input, "type", "email");
    			attr_dev(input, "placeholder", "email@example.com");
    			input.required = true;
    			attr_dev(input, "class", "svelte-1bck");
    			add_location(input, file$5, 129, 0, 3480);
    			attr_dev(p1, "class", "error-display svelte-1bck");
    			toggle_class(p1, "error", !correctEmailFormat(/*inputValue*/ ctx[0]));
    			add_location(p1, file$5, 130, 0, 3568);
    			attr_dev(button, "class", "svelte-1bck");
    			add_location(button, file$5, 131, 0, 3644);
    			attr_dev(div0, "class", "svelte-1bck");
    			add_location(div0, file$5, 128, 0, 3474);
    			attr_dev(form, "class", "svelte-1bck");
    			add_location(form, file$5, 125, 4, 3273);
    			attr_dev(div1, "class", "signup-container svelte-1bck");
    			add_location(div1, file$5, 124, 0, 3238);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-2za3nt");
    			add_location(img, file$4, 79, 4, 1918);
    			attr_dev(div0, "class", "hero-image svelte-2za3nt");
    			add_location(div0, file$4, 78, 0, 1889);
    			attr_dev(h1, "class", "svelte-2za3nt");
    			add_location(h1, file$4, 82, 0, 2021);
    			attr_dev(p, "class", "svelte-2za3nt");
    			add_location(p, file$4, 83, 0, 2090);
    			attr_dev(button, "class", "btn svelte-2za3nt");
    			add_location(button, file$4, 85, 2, 2259);
    			attr_dev(section, "class", "svelte-2za3nt");
    			add_location(section, file$4, 81, 0, 2011);
    			attr_dev(div1, "class", "main-sales svelte-2za3nt");
    			add_location(div1, file$4, 77, 0, 1864);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "alt", "");
    			attr_dev(img0, "class", "svelte-us0grz");
    			add_location(img0, file$3, 41, 8, 904);
    			attr_dev(h20, "class", "svelte-us0grz");
    			add_location(h20, file$3, 42, 8, 966);
    			attr_dev(p0, "class", "svelte-us0grz");
    			add_location(p0, file$3, 43, 8, 1011);
    			attr_dev(div0, "class", "sales-point svelte-us0grz");
    			add_location(div0, file$3, 40, 4, 870);
    			if (!src_url_equal(img1.src, img1_src_value = "./images/icon-security.svg")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "");
    			attr_dev(img1, "class", "svelte-us0grz");
    			add_location(img1, file$3, 47, 8, 1186);
    			attr_dev(h21, "class", "svelte-us0grz");
    			add_location(h21, file$3, 48, 8, 1241);
    			attr_dev(p1, "class", "svelte-us0grz");
    			add_location(p1, file$3, 49, 8, 1281);
    			attr_dev(div1, "class", "sales-point svelte-us0grz");
    			add_location(div1, file$3, 46, 4, 1152);
    			if (!src_url_equal(img2.src, img2_src_value = "./images/icon-collaboration.svg")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "");
    			attr_dev(img2, "class", "svelte-us0grz");
    			add_location(img2, file$3, 53, 8, 1474);
    			attr_dev(h22, "class", "svelte-us0grz");
    			add_location(h22, file$3, 54, 8, 1534);
    			attr_dev(p2, "class", "svelte-us0grz");
    			add_location(p2, file$3, 55, 8, 1575);
    			attr_dev(div2, "class", "sales-point svelte-us0grz");
    			add_location(div2, file$3, 52, 4, 1440);
    			if (!src_url_equal(img3.src, img3_src_value = "./images/icon-any-file.svg")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "");
    			attr_dev(img3, "class", "svelte-us0grz");
    			add_location(img3, file$3, 59, 8, 1759);
    			attr_dev(h23, "class", "svelte-us0grz");
    			add_location(h23, file$3, 60, 8, 1814);
    			attr_dev(p3, "class", "svelte-us0grz");
    			add_location(p3, file$3, 61, 8, 1854);
    			attr_dev(div3, "class", "sales-point svelte-us0grz");
    			add_location(div3, file$3, 58, 5, 1725);
    			attr_dev(section, "class", "sales-points-container svelte-us0grz");
    			add_location(section, file$3, 39, 0, 825);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-1rmld6");
    			add_location(img, file$2, 112, 8, 2408);
    			attr_dev(div0, "class", "image-container svelte-1rmld6");
    			add_location(div0, file$2, 111, 4, 2370);
    			attr_dev(h2, "class", "svelte-1rmld6");
    			add_location(h2, file$2, 116, 8, 2556);
    			attr_dev(p0, "class", "svelte-1rmld6");
    			add_location(p0, file$2, 117, 8, 2607);
    			attr_dev(p1, "class", "svelte-1rmld6");
    			add_location(p1, file$2, 119, 8, 2746);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "svelte-1rmld6");
    			add_location(a, file$2, 122, 12, 2936);
    			attr_dev(circle, "id", "b");
    			attr_dev(circle, "cx", "6");
    			attr_dev(circle, "cy", "6");
    			attr_dev(circle, "r", "6");
    			add_location(circle, file$2, 123, 124, 3099);
    			attr_dev(feOffset, "in", "SourceAlpha");
    			attr_dev(feOffset, "result", "shadowOffsetOuter1");
    			add_location(feOffset, file$2, 123, 252, 3227);
    			...
    			add_location(feGaussianBlur, file$2, 123, 308, 3283);
    			...
    			add_location(feColorMatrix, file$2, 123, 392, 3367);
    			...
    			add_location(filter, file$2, 123, 160, 3135);
    			add_location(defs, file$2, 123, 118, 3093);
    			attr_dev(use0, "fill", "#000");
    			attr_dev(use0, "filter", "url(#a)");
    			xlink_attr(use0, "xlink:href", "#b");
    			add_location(use0, file$2, 123, 600, 3575);
    			attr_dev(use1, "id", "change-bg");
    			xlink_attr(use1, "xlink:href", "#b");
    			attr_dev(use1, "class", "svelte-1rmld6");
    			add_location(use1, file$2, 123, 651, 3626);
    			attr_dev(g0, "transform", "translate(2 2)");
    			add_location(g0, file$2, 123, 570, 3545);
    			attr_dev(path, "d", "M8.582 6l-.363.35 1.452 1.4H5.333v.5h4.338L8.22 9.65l.363.35 2.074-2z");
    			attr_dev(path, "fill", "#1B2330");
    			add_location(path, file$2, 123, 693, 3668);
    			attr_dev(g1, "fill", "none");
    			attr_dev(g1, "fill-rule", "evenodd");
    			add_location(g1, file$2, 123, 535, 3510);
    			attr_dev(svg, "width", "16");
    			attr_dev(svg, "height", "16");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "xmlns:xlink", "http://www.w3.org/1999/xlink");
    			add_location(svg, file$2, 123, 12, 2987);
    			attr_dev(div1, "class", "link-container svelte-1rmld6");
    			add_location(div1, file$2, 121, 8, 2895);
    			attr_dev(div2, "class", "productivity-description svelte-1rmld6");
    			add_location(div2, file$2, 115, 4, 2509);
    			attr_dev(section, "class", "productive-container svelte-1rmld6");
    			add_location(section, file$2, 110, 0, 2327);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "bg-quotes svelte-1d2xbe3");
    			add_location(img0, file$1, 96, 4, 2242);
    			attr_dev(p0, "class", "svelte-1d2xbe3");
    			add_location(p0, file$1, 98, 8, 2333);
    			...
    			attr_dev(img1, "class", "profile-pic svelte-1d2xbe3");
    			add_location(img1, file$1, 101, 12, 2552);
    			attr_dev(h20, "class", "svelte-1d2xbe3");
    			add_location(h20, file$1, 102, 12, 2638);
    			attr_dev(p1, "class", "user-description svelte-1d2xbe3");
    			add_location(p1, file$1, 103, 12, 2672);
    			attr_dev(div0, "class", "user-information-container svelte-1d2xbe3");
    			add_location(div0, file$1, 100, 8, 2499);
    			attr_dev(div1, "class", "testimonial svelte-1d2xbe3");
    			add_location(div1, file$1, 97, 4, 2299);
    			attr_dev(p2, "class", "svelte-1d2xbe3");
    			add_location(p2, file$1, 107, 8, 2791);
    			...
    			attr_dev(img2, "class", "profile-pic svelte-1d2xbe3");
    			add_location(img2, file$1, 110, 12, 3010);
    			attr_dev(h21, "class", "svelte-1d2xbe3");
    			add_location(h21, file$1, 111, 12, 3099);
    			attr_dev(p3, "class", "user-description svelte-1d2xbe3");
    			add_location(p3, file$1, 112, 12, 3135);
    			attr_dev(div2, "class", "user-information-container svelte-1d2xbe3");
    			add_location(div2, file$1, 109, 8, 2957);
    			attr_dev(div3, "class", "testimonial svelte-1d2xbe3");
    			add_location(div3, file$1, 106, 4, 2757);
    			attr_dev(p4, "class", "svelte-1d2xbe3");
    			add_location(p4, file$1, 116, 8, 3253);
    			if (!src_url_equal(img3.src, img3_src_value = "./images/profile-3.jpg")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "Iva Boy");
    			attr_dev(img3, "class", "profile-pic svelte-1d2xbe3");
    			add_location(img3, file$1, 119, 12, 3472);
    			attr_dev(h22, "class", "svelte-1d2xbe3");
    			add_location(h22, file$1, 120, 12, 3554);
    			attr_dev(p5, "class", "user-description svelte-1d2xbe3");
    			add_location(p5, file$1, 121, 12, 3583);
    			attr_dev(div4, "class", "user-information-container svelte-1d2xbe3");
    			add_location(div4, file$1, 118, 8, 3419);
    			attr_dev(div5, "class", "testimonial svelte-1d2xbe3");
    			add_location(div5, file$1, 115, 4, 3219);
    			attr_dev(section, "class", "testimonials-container svelte-1d2xbe3");
    			add_location(section, file$1, 95, 0, 2197);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(header, "class", "svelte-1jc2w3r");
    			add_location(header, file, 43, 0, 910);
    			attr_dev(div, "class", "position-sign-up svelte-1jc2w3r");
    			add_location(div, file, 51, 1, 1013);
    			attr_dev(main, "class", "svelte-1jc2w3r");
    			add_location(main, file, 46, 0, 943);
    			attr_dev(footer1, "class", "svelte-1jc2w3r");
    			add_location(footer1, file, 55, 0, 1071);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
