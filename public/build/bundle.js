    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-511qat");
    			add_location(h2, file$5, 113, 0, 2969);
    			attr_dev(p0, "class", "svelte-511qat");
    			add_location(p0, file$5, 114, 0, 3001);
    			attr_dev(input, "type", "email");
    			attr_dev(input, "placeholder", "email@example.com");
    			input.required = true;
    			attr_dev(input, "class", "svelte-511qat");
    			add_location(input, file$5, 116, 0, 3169);
    			attr_dev(p1, "class", "error-display svelte-511qat");
    			toggle_class(p1, "error", !correctEmailFormat(/*inputValue*/ ctx[0]));
    			add_location(p1, file$5, 117, 0, 3257);
    			attr_dev(button, "class", "svelte-511qat");
    			add_location(button, file$5, 118, 0, 3333);
    			attr_dev(div0, "class", "svelte-511qat");
    			add_location(div0, file$5, 115, 0, 3163);
    			attr_dev(form, "class", "svelte-511qat");
    			add_location(form, file$5, 112, 4, 2962);
    			attr_dev(div1, "class", "signup-container svelte-511qat");
    			add_location(div1, file$5, 111, 0, 2927);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-1r8i34q");
    			add_location(img, file$4, 71, 4, 1692);
    			attr_dev(div0, "class", "hero-image svelte-1r8i34q");
    			add_location(div0, file$4, 70, 0, 1663);
    			attr_dev(h1, "class", "svelte-1r8i34q");
    			add_location(h1, file$4, 74, 0, 1795);
    			attr_dev(p, "class", "svelte-1r8i34q");
    			add_location(p, file$4, 75, 0, 1864);
    			attr_dev(button, "class", "btn svelte-1r8i34q");
    			add_location(button, file$4, 77, 2, 2033);
    			attr_dev(section, "class", "svelte-1r8i34q");
    			add_location(section, file$4, 73, 0, 1785);
    			attr_dev(div1, "class", "main-sales svelte-1r8i34q");
    			add_location(div1, file$4, 69, 0, 1638);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "alt", "");
    			attr_dev(img0, "class", "svelte-syp99q");
    			add_location(img0, file$3, 40, 8, 865);
    			attr_dev(h20, "class", "svelte-syp99q");
    			add_location(h20, file$3, 41, 8, 927);
    			attr_dev(p0, "class", "svelte-syp99q");
    			add_location(p0, file$3, 42, 8, 972);
    			attr_dev(div0, "class", "sales-point svelte-syp99q");
    			add_location(div0, file$3, 39, 4, 831);
    			if (!src_url_equal(img1.src, img1_src_value = "./images/icon-security.svg")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "");
    			attr_dev(img1, "class", "svelte-syp99q");
    			add_location(img1, file$3, 46, 8, 1147);
    			attr_dev(h21, "class", "svelte-syp99q");
    			add_location(h21, file$3, 47, 8, 1202);
    			attr_dev(p1, "class", "svelte-syp99q");
    			add_location(p1, file$3, 48, 8, 1242);
    			attr_dev(div1, "class", "sales-point svelte-syp99q");
    			add_location(div1, file$3, 45, 4, 1113);
    			if (!src_url_equal(img2.src, img2_src_value = "./images/icon-collaboration.svg")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "");
    			attr_dev(img2, "class", "svelte-syp99q");
    			add_location(img2, file$3, 52, 8, 1435);
    			attr_dev(h22, "class", "svelte-syp99q");
    			add_location(h22, file$3, 53, 8, 1495);
    			attr_dev(p2, "class", "svelte-syp99q");
    			add_location(p2, file$3, 54, 8, 1536);
    			attr_dev(div2, "class", "sales-point svelte-syp99q");
    			add_location(div2, file$3, 51, 4, 1401);
    			if (!src_url_equal(img3.src, img3_src_value = "./images/icon-any-file.svg")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "");
    			attr_dev(img3, "class", "svelte-syp99q");
    			add_location(img3, file$3, 58, 8, 1720);
    			attr_dev(h23, "class", "svelte-syp99q");
    			add_location(h23, file$3, 59, 8, 1775);
    			attr_dev(p3, "class", "svelte-syp99q");
    			add_location(p3, file$3, 60, 8, 1815);
    			attr_dev(div3, "class", "sales-point svelte-syp99q");
    			add_location(div3, file$3, 57, 5, 1686);
    			attr_dev(section, "class", "sales-points-container svelte-syp99q");
    			add_location(section, file$3, 38, 0, 786);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-13talgr");
    			add_location(img, file$2, 94, 8, 2043);
    			attr_dev(div0, "class", "image-container svelte-13talgr");
    			add_location(div0, file$2, 93, 4, 2005);
    			attr_dev(h2, "class", "svelte-13talgr");
    			add_location(h2, file$2, 98, 8, 2191);
    			attr_dev(p0, "class", "svelte-13talgr");
    			add_location(p0, file$2, 99, 8, 2242);
    			attr_dev(p1, "class", "svelte-13talgr");
    			add_location(p1, file$2, 101, 8, 2381);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "svelte-13talgr");
    			add_location(a, file$2, 104, 12, 2571);
    			attr_dev(circle, "id", "b");
    			attr_dev(circle, "cx", "6");
    			attr_dev(circle, "cy", "6");
    			attr_dev(circle, "r", "6");
    			add_location(circle, file$2, 105, 124, 2734);
    			attr_dev(feOffset, "in", "SourceAlpha");
    			attr_dev(feOffset, "result", "shadowOffsetOuter1");
    			add_location(feOffset, file$2, 105, 252, 2862);
    			...
    			add_location(feGaussianBlur, file$2, 105, 308, 2918);
    			...
    			add_location(feColorMatrix, file$2, 105, 392, 3002);
    			...
    			add_location(filter, file$2, 105, 160, 2770);
    			add_location(defs, file$2, 105, 118, 2728);
    			attr_dev(use0, "fill", "#000");
    			attr_dev(use0, "filter", "url(#a)");
    			xlink_attr(use0, "xlink:href", "#b");
    			add_location(use0, file$2, 105, 600, 3210);
    			attr_dev(use1, "id", "change-bg");
    			xlink_attr(use1, "xlink:href", "#b");
    			attr_dev(use1, "class", "svelte-13talgr");
    			add_location(use1, file$2, 105, 651, 3261);
    			attr_dev(g0, "transform", "translate(2 2)");
    			add_location(g0, file$2, 105, 570, 3180);
    			attr_dev(path, "d", "M8.582 6l-.363.35 1.452 1.4H5.333v.5h4.338L8.22 9.65l.363.35 2.074-2z");
    			attr_dev(path, "fill", "#1B2330");
    			add_location(path, file$2, 105, 693, 3303);
    			attr_dev(g1, "fill", "none");
    			attr_dev(g1, "fill-rule", "evenodd");
    			add_location(g1, file$2, 105, 535, 3145);
    			attr_dev(svg, "width", "16");
    			attr_dev(svg, "height", "16");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "xmlns:xlink", "http://www.w3.org/1999/xlink");
    			add_location(svg, file$2, 105, 12, 2622);
    			attr_dev(div1, "class", "link-container svelte-13talgr");
    			add_location(div1, file$2, 103, 8, 2530);
    			attr_dev(div2, "class", "productivity-description svelte-13talgr");
    			add_location(div2, file$2, 97, 4, 2144);
    			attr_dev(section, "class", "productive-container svelte-13talgr");
    			add_location(section, file$2, 92, 0, 1962);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "bg-quotes svelte-bgq4n6");
    			add_location(img0, file$1, 77, 4, 1794);
    			attr_dev(p0, "class", "svelte-bgq4n6");
    			add_location(p0, file$1, 79, 8, 1885);
    			...
    			attr_dev(img1, "class", "profile-pic svelte-bgq4n6");
    			add_location(img1, file$1, 82, 12, 2104);
    			attr_dev(h20, "class", "svelte-bgq4n6");
    			add_location(h20, file$1, 83, 12, 2190);
    			attr_dev(p1, "class", "user-description svelte-bgq4n6");
    			add_location(p1, file$1, 84, 12, 2224);
    			attr_dev(div0, "class", "user-information-container svelte-bgq4n6");
    			add_location(div0, file$1, 81, 8, 2051);
    			attr_dev(div1, "class", "testimonial svelte-bgq4n6");
    			add_location(div1, file$1, 78, 4, 1851);
    			attr_dev(p2, "class", "svelte-bgq4n6");
    			add_location(p2, file$1, 88, 8, 2343);
    			...
    			attr_dev(img2, "class", "profile-pic svelte-bgq4n6");
    			add_location(img2, file$1, 91, 12, 2562);
    			attr_dev(h21, "class", "svelte-bgq4n6");
    			add_location(h21, file$1, 92, 12, 2651);
    			attr_dev(p3, "class", "user-description svelte-bgq4n6");
    			add_location(p3, file$1, 93, 12, 2687);
    			attr_dev(div2, "class", "user-information-container svelte-bgq4n6");
    			add_location(div2, file$1, 90, 8, 2509);
    			attr_dev(div3, "class", "testimonial svelte-bgq4n6");
    			add_location(div3, file$1, 87, 4, 2309);
    			attr_dev(p4, "class", "svelte-bgq4n6");
    			add_location(p4, file$1, 97, 8, 2805);
    			if (!src_url_equal(img3.src, img3_src_value = "./images/profile-3.jpg")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "Iva Boy");
    			attr_dev(img3, "class", "profile-pic svelte-bgq4n6");
    			add_location(img3, file$1, 100, 12, 3024);
    			attr_dev(h22, "class", "svelte-bgq4n6");
    			add_location(h22, file$1, 101, 12, 3106);
    			attr_dev(p5, "class", "user-description svelte-bgq4n6");
    			add_location(p5, file$1, 102, 12, 3135);
    			attr_dev(div4, "class", "user-information-container svelte-bgq4n6");
    			add_location(div4, file$1, 99, 8, 2971);
    			attr_dev(div5, "class", "testimonial svelte-bgq4n6");
    			add_location(div5, file$1, 96, 4, 2771);
    			attr_dev(section, "class", "testimonials-container svelte-bgq4n6");
    			add_location(section, file$1, 76, 0, 1749);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(header, "class", "svelte-1635hq3");
    			add_location(header, file, 37, 0, 821);
    			attr_dev(div, "class", "position-sign-up svelte-1635hq3");
    			add_location(div, file, 45, 1, 924);
    			attr_dev(main, "class", "svelte-1635hq3");
    			add_location(main, file, 40, 0, 854);
    			attr_dev(footer1, "class", "svelte-1635hq3");
    			add_location(footer1, file, 49, 0, 982);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
